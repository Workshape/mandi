...
module.exports = function () {
  return { applyTransformations, getMeta }
  ...
  /**
   * Get image meta (like the size) on files matching resizable types
   *
   * @param  {Object} file
   * @return {Object}
   */
  function getMeta(file) {
    if (!_.includes(RESIZABLES, file.type)) { return {} }
    return sizeOf(file.path)
  }
